package com.tpirates.apitest.util;
...
public class EntityConverter {
    ...
    /**
     * dto의 prop을 복사하여 entityClass Type의 영속성 인스턴스를 반환합니다.
     * dto가 Entity의 @Id prop을 가지고 있다면 EntityManager를 통해 DB의 값을 가져오고
    ...
    public <E,D> E getEntity(D dto, Class<E> entityClass){
        ...
        if(entityClass.getAnnotation(Entity.class) == null){
            throw new IllegalArgumentException(entityClass.getName() + " class is not Entity");
        }
